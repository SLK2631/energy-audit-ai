    ...
    <div style={{ minHeight: "100vh", background: T.bg, fontFamily: "'DM Sans',system-ui,sans-serif", color: T.text, transition: "background .3s,color .3s" }}>
      ...
      <div style={{ borderBottom: `1px solid ${T.topbarBorder}`, padding: "12px 24px", display: "flex", alignItems: "center", justifyContent: "space-between", position: "sticky", top: 0, background: T.topbar, zIndex: 100, backdropFilter: "blur(10px)", flexWrap: "wrap", gap: "8px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "10px", flexWrap: "wrap" }}>
          ...
          <a href="https://mymeteriq.com" style={{ background: "linear-gradient(135deg,#38BDF8,#0EA5E9)", border: "none", color: "#040d18", padding: "7px 14px", borderRadius: "7px", cursor: "pointer", fontSize: "11px", fontWeight: "700", fontFamily: "monospace", textDecoration: "none" }}>Get Access →</a>
        </div>
      </div>
      ...
      <div style={{ borderTop: `1px solid ${T.border}`, padding: "20px 24px", textAlign: "center", fontSize: "11px", color: T.textDim }}>
        ...
        <span style={{ margin: "0 12px", color: T.textFaint }}>·</span>
        <a href="https://mymeteriq.com" style={{ color: "#38BDF8", textDecoration: "none" }}>Get Full Access →</a>
      </div>
    </div>
  );
};
