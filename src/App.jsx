...
<div class="sec meth">
  ...
  <div class="disc">
    <strong>Important Disclaimer:</strong> This report is generated using AI analysis of your submitted utility bill and cross-referenced against publicly available rate schedules and benchmarks. Rate schedules are subject to change; all identified errors and recommendations should be verified against your utility's current published tariff schedule before taking action. MyMeterIQ recommends requesting a formal billing audit directly from your utility provider for any disputed charges. This report does not constitute legal or financial advice.
  </div>
</div>
</div></div></div>
  </div><div class="ftr"><div class="fb">⚡ MyMeterIQ · ${now}</div><div class="fd">AI-generated report. Verify all recommendations with your utility provider and a licensed energy auditor before major decisions.</div></div></div></body></html>`;
}
...
function buildCompareReport(left, right, completedActions) {
  ...
  <div class="hdr">
    <div style="display:flex;align-items:center;gap:14px;margin-bottom:16px">
      ${LOGO_SVG}
      <div><div class="lbl">MyMeterIQ</div><div style="font-family:'DM Mono',monospace;font-size:11px;color:#6b87a4;letter-spacing:0.08em">⚖ Bill Comparison Report</div></div>
    </div>
  ...
  <div class="ftr"><div class="fb">⚡ MyMeterIQ · ${now}</div><div class="fd">AI-generated comparison report. Verify all findings against current published utility tariff schedules before taking action.</div></div>
</div></body></html>`;
}
...
// ─── DEMO DATA — RESIDENTIAL (Electric + Gas + Water, 6 months) ───────────────
const mkDemoDate = (n) => new Date(Date.now() - n * 30 * 24 * 3600 * 1000).toISOString();

const RES_BILLS = [
  { id:"rd1", analyzedAt:mkDemoDate(5), result:{ billType:"ELECTRIC", provider:"Duke Energy Carolinas", accountNumber:"4821-009-117", billingPeriod:"Oct 15 – Nov 14, 2024", totalCharged:"$127.40", totalUsage:"712 kWh", ratePerUnit:"$0.1263 per kWh", billStatus:"LIKELY_CORRECT", billStatusReason:"All charges align with Duke Energy's RS-1 residential rate schedule.", suspiciousCharges:[], potentialErrors:[], usageRating:"AVERAGE", usageRatingExplanation:"712 kWh is within the normal range for a 3-person NC household in October.", regionalComparison:{yourBill:"$127.40",regionalAverage:"$118.00",percentageDifference:"+8% above average",comparisonNote:"Slightly above NC average — mild heating use beginning."}, recommendations:{ negotiation:[{title:"Enroll in Duke Energy's Average Billing Program",description:"Smooths spikes across 12 months — avoids summer/winter bill shock. Call 1-800-452-2777 to enroll.",estimatedSavings:"$0/month direct but eliminates budget volatility",difficulty:"Easy"}], ratePlans:[{title:"Switch to Time-of-Use Rate (TOU-EV)",description:"If you run dishwasher, laundry, and EV charging after 9 PM, TOU-EV saves on overnight kWh.",estimatedSavings:"$15–$28/month",difficulty:"Easy"}], providers:[], equipment:[{title:"Smart Thermostat (Ecobee/Nest)",description:"Learns your schedule, auto-setback saves 10–12% on HVAC costs in shoulder seasons.",estimatedSavings:"$12–$20/month",difficulty:"Easy",upfrontCost:"$150–$250"}], behavioral:[{title:"Shift Laundry & Dishwasher to After 9 PM",description:"NC is not deregulated but load shifting reduces demand peaks that affect future rate cases.",estimatedSavings:"$8–$14/month",difficulty:"Easy"}], incentives:[{title:"Duke Energy Smart $aver Thermostat Rebate",description:"Up to $75 rebate on qualifying Ecobee or Nest thermostats through Duke Energy NC program.",estimatedSavings:"One-time $50–$75",difficulty:"Easy"}] }, totalPotentialMonthlySavings:"$25–$50/month", totalPotentialAnnualSavings:"$300–$600/year", priorityAction:"Install a smart thermostat — easiest single action, qualifies for Duke rebate, and saves automatically.", analysisConfidence:"HIGH", confidenceNote:"Clean bill with all line items visible." }},
  { id:"rd2", analyzedAt:mkDemoDate(4), result:{ billType:"GAS", provider:"Piedmont Natural Gas", accountNumber:"8820-114-003", billingPeriod:"Nov 15 – Dec 14, 2024", totalCharged:"$148.60", totalUsage:"72 therms", ratePerUnit:"$1.421 per therm", billStatus:"NEEDS_REVIEW", billStatusReason:"Distribution charge increased 12% vs. prior period with no announced rate change. Verify against Piedmont tariff schedule.", suspiciousCharges:["Distribution charge jumped 12% — no rate case approved for this period"], potentialErrors:["Check whether budget billing is averaging incorrectly"], usageRating:"AVERAGE", usageRatingExplanation:"72 therms is normal for a 3-person NC household in December. Heating season baseline.", regionalComparison:{yourBill:"$148.60",regionalAverage:"$132.00",percentageDifference:"+13% above average",comparisonNote:"Above average — partially explained by distribution charge anomaly."}, recommendations:{ negotiation:[{title:"Call Piedmont About Distribution Charge Spike",description:"Call 1-800-752-7504. Say: 'My distribution charge increased 12% this month. Can you verify this matches the current NCUC-approved tariff?' Request a credit if overcharged.",estimatedSavings:"$15–$22/month",difficulty:"Easy"}], ratePlans:[{title:"Budget Billing to Smooth Seasonal Spikes",description:"Piedmont averages your annual usage into equal monthly payments — eliminates the $150+ winter bills.",estimatedSavings:"$0 net but smooths cash flow",difficulty:"Easy"}], providers:[], equipment:[{title:"Programmable Setback — Gas Furnace",description:"Set to 62°F overnight and when away. Each degree saves ~2% on heating. A 7-degree setback saves 14%.",estimatedSavings:"$18–$28/month",difficulty:"Easy",upfrontCost:"$0 if you have a programmable thermostat"}], behavioral:[{title:"Water Heater Temperature Reduction",description:"Lower from 140°F to 120°F. Reduces gas consumption 6–10% with no comfort impact.",estimatedSavings:"$8–$12/month",difficulty:"Easy"}], incentives:[{title:"Federal 25C Tax Credit — High-Efficiency Furnace",description:"30% credit (up to $600) on a 95%+ AFUE gas furnace. NC also offers a state credit on some upgrades.",estimatedSavings:"One-time $400–$600",difficulty:"Medium"}] }, totalPotentialMonthlySavings:"$35–$60/month", totalPotentialAnnualSavings:"$420–$720/year", priorityAction:"Call Piedmont Natural Gas today about the unexplained distribution charge spike — this is potentially a billing error with retroactive refund potential.", analysisConfidence:"MEDIUM", confidenceNote:"Distribution charge anomaly reduces confidence until verified." }},
  { id:"rd3", analyzedAt:mkDemoDate(3), result:{ billType:"WATER", provider:"City of Raleigh Utilities", accountNumber:"WS-4421-A", billingPeriod:"Dec 1 – Dec 31, 2024", totalCharged:"$89.20", totalUsage:"6,800 gallons", ratePerUnit:"$0.0084 per gallon (blended)", billStatus:"SUSPICIOUS", billStatusReason:"Sewer multiplier applied to 100% of water consumption. Household has an irrigation system — sewer charge should be waived on outdoor irrigation volume.", suspiciousCharges:["Sewer charge applied to estimated outdoor irrigation — should be excluded per Raleigh municipal code"], potentialErrors:["No irrigation meter credit applied despite active backflow permit on file"], usageRating:"AVERAGE", usageRatingExplanation:"6,800 gallons is within the expected range for a 3-person household in December (minimal irrigation).", regionalComparison:{yourBill:"$89.20",regionalAverage:"$74.00",percentageDifference:"+21% above average",comparisonNote:"Above average primarily due to incorrect sewer calculation."}, recommendations:{ negotiation:[{title:"Request Irrigation Meter Credit Immediately",description:"Call Raleigh Utilities at 919-996-3245. Reference your backflow permit and request retroactive sewer credit on outdoor usage. This is an established right under municipal code.",estimatedSavings:"$18–$30/month",difficulty:"Easy"}], ratePlans:[{title:"Apply for Separate Irrigation Meter",description:"Installing a dedicated irrigation meter eliminates sewer charges on all outdoor water — saves $20–$40/month in growing season.",estimatedSavings:"$20–$40/month (Apr–Oct)",difficulty:"Medium"}], providers:[], equipment:[{title:"Smart Irrigation Controller (Rachio/RainBird)",description:"Connects to weather data — skips watering when rain is forecast. Reduces irrigation by 30–50%.",estimatedSavings:"$12–$24/month",difficulty:"Easy",upfrontCost:"$80–$200"}], behavioral:[{title:"Leak Check at 2 AM",description:"Check your water meter at 2 AM when nothing should be running. Any movement = active leak. Fix before next billing cycle.",estimatedSavings:"$10–$40/month if leak present",difficulty:"Easy"}], incentives:[{title:"City of Raleigh WaterSense Rebate",description:"Up to $100 rebate on qualifying smart irrigation controllers. Apply at raleighnc.gov/water.",estimatedSavings:"One-time $75–$100",difficulty:"Easy"}] }, totalPotentialMonthlySavings:"$40–$70/month", totalPotentialAnnualSavings:"$480–$840/year", priorityAction:"Call Raleigh Utilities today — the sewer multiplier error is a clear billing mistake. You're owed a retroactive credit and a corrected rate going forward.", analysisConfidence:"HIGH", confidenceNote:"Billing error clearly documented in line items." }},
  { id:"rd4", analyzedAt:mkDemoDate(2), result:{ billType:"ELECTRIC", provider:"Duke Energy Carolinas", accountNumber:"4821-009-117", billingPeriod:"Jan 15 – Feb 14, 2025", totalCharged:"$158.70", totalUsage:"891 kWh", ratePerUnit:"$0.1263 per kWh", billStatus:"NEEDS_REVIEW", billStatusReason:"Usage jumped 25% from October — likely heating-related, but smart thermostat not yet installed.", suspiciousCharges:[], potentialErrors:["No TOU plan in place — missing off-peak savings during high-usage winter month"], usageRating:"HIGH", usageRatingExplanation:"891 kWh is above the typical range for a 3-person NC household in January. Electric heat likely active.", regionalComparison:{yourBill:"$158.70",regionalAverage:"$138.00",percentageDifference:"+15% above average",comparisonNote:"Above average for January — HVAC efficiency and heating mode are the primary drivers."}, recommendations:{ negotiation:[{title:"Request Billing History Review",description:"Ask Duke to confirm all months used correct baseline allowance for your climate zone (Zone 4, Raleigh).",estimatedSavings:"$10–$25 potential refund",difficulty:"Easy"}], ratePlans:[{title:"TOU-EV Rate — Enroll Before Summer",description:"Winter off-peak savings are immediate. Enroll at duke-energy.com — takes 1 billing cycle to activate.",estimatedSavings:"$20–$35/month",difficulty:"Easy"}], providers:[], equipment:[{title:"Heat Pump Tune-Up",description:"Annual HVAC service ($150–$300) restores 10–15% efficiency loss from dirty coils and low refrigerant.",estimatedSavings:"$18–$28/month",difficulty:"Easy",upfrontCost:"$150–$300 one-time"}], behavioral:[{title:"Setback 7–10°F When Sleeping or Away",description:"The single most effective behavioral change for heating costs. Use your thermostat schedule.",estimatedSavings:"$15–$25/month",difficulty:"Easy"}], incentives:[{title:"Duke Energy Home Energy Improvement Rebate",description:"Up to $500 rebate on qualifying heat pump upgrades through Duke's NC residential program.",estimatedSavings:"One-time $200–$500",difficulty:"Medium"}] }, totalPotentialMonthlySavings:"$40–$75/month", totalPotentialAnnualSavings:"$480–$900/year", priorityAction:"Enroll in TOU-EV rate plan now — free, immediate, and specifically designed for high winter usage households.", analysisConfidence:"HIGH", confidenceNote:"All line items verified against published RS-1 tariff." }},
  { id:"rd5", analyzedAt:mkDemoDate(1), result:{ billType:"GAS", provider:"Piedmont Natural Gas", accountNumber:"8820-114-003", billingPeriod:"Feb 15 – Mar 14, 2025", totalCharged:"$118.30", totalUsage:"56 therms", ratePerUnit:"$1.421 per therm", billStatus:"LIKELY_CORRECT", billStatusReason:"Distribution charge corrected after prior-month dispute. Bill now matches published tariff schedule.", suspiciousCharges:[], potentialErrors:[], usageRating:"AVERAGE", usageRatingExplanation:"56 therms for late winter is in the expected range. Usage trending down as temperatures moderate.", regionalComparison:{yourBill:"$118.30",regionalAverage:"$109.00",percentageDifference:"+8% above average",comparisonNote:"Slightly above average — improving from December. Distribution charge correction applied."}, recommendations:{ negotiation:[], ratePlans:[{title:"Lock In Budget Billing Before Next Winter",description:"Enroll in budget billing now so next heating season doesn't create $150+ spikes.",estimatedSavings:"$0 net but eliminates cash flow shock",difficulty:"Easy"}], providers:[], equipment:[{title:"Tankless Water Heater Upgrade",description:"Replace tank water heater with condensing tankless — 30% more efficient, unlimited hot water.",estimatedSavings:"$20–$35/month",difficulty:"Medium",upfrontCost:"$1,200–$2,500"}], behavioral:[{title:"Pipe Insulation on Hot Water Lines",description:"Insulate the first 6 feet of hot water pipe from the heater — reduces standby heat loss immediately.",estimatedSavings:"$5–$10/month",difficulty:"Easy",upfrontCost:"$20–$40"}], incentives:[{title:"Federal 25C — Tankless Water Heater Credit",description:"30% federal tax credit up to $600 on a qualifying condensing tankless gas water heater.",estimatedSavings:"One-time $300–$600",difficulty:"Medium"}] }, totalPotentialMonthlySavings:"$25–$45/month", totalPotentialAnnualSavings:"$300–$540/year", priorityAction:"Upgrade to tankless water heater — combines with the 30% federal tax credit for the fastest payback of any gas equipment upgrade.", analysisConfidence:"HIGH", confidenceNote:"Clean bill. Distribution charge dispute resolved." }},
  { id:"rd6", analyzedAt:mkDemoDate(0), result:{ billType:"WATER", provider:"City of Raleigh Utilities", accountNumber:"WS-4421-A", billingPeriod:"Mar 1 – Mar 31, 2025", totalCharged:"$67.80", totalUsage:"5,400 gallons", ratePerUnit:"$0.0084 per gallon (blended)", billStatus:"LIKELY_CORRECT", billStatusReason:"Sewer multiplier corrected after prior-month dispute. Irrigation credit now applied correctly.", suspiciousCharges:[], potentialErrors:[], usageRating:"AVERAGE", usageRatingExplanation:"5,400 gallons is at the low end of normal for March — irrigation not yet active. Good conservation habits.", regionalComparison:{yourBill:"$67.80",regionalAverage:"$74.00",percentageDifference:"-8% below average",comparisonNote:"Below average — sewer credit applied correctly and conservation habits are working."}, recommendations:{ negotiation:[], ratePlans:[{title:"Seasonal Irrigation Meter — Before Summer",description:"Get the separate irrigation meter installed before April so you're ready for irrigation season with zero sewer charges on outdoor water.",estimatedSavings:"$20–$40/month Apr–Oct",difficulty:"Medium"}], providers:[], equipment:[{title:"Low-Flow Showerhead (WaterSense)",description:"Replace standard showerheads with WaterSense-certified models — saves 2,700 gallons per year per shower.",estimatedSavings:"$8–$14/month",difficulty:"Easy",upfrontCost:"$20–$50"}], behavioral:[{title:"Check Irrigation System Before Activation",description:"Before turning on irrigation for the season, check all heads for leaks or broken rotors. A single broken head wastes 500–1000 gallons per cycle.",estimatedSavings:"$10–$30/month if leak present",difficulty:"Easy"}], incentives:[{title:"City of Raleigh WaterSense Fixture Rebate",description:"Up to $100 on qualifying low-flow fixtures. Apply at raleighnc.gov/water before May 1.",estimatedSavings:"One-time $50–$100",difficulty:"Easy"}] }, totalPotentialMonthlySavings:"$25–$55/month", totalPotentialAnnualSavings:"$300–$660/year", priorityAction:"Schedule irrigation meter installation now — before summer irrigation season starts. Eliminates sewer charges on all outdoor water use.", analysisConfidence:"HIGH", confidenceNote:"Clean bill with all corrections applied." }},
];

// ─── DEMO DATA — COMMERCIAL (Electric + Gas + Water, 6 months) ────────────────
const COM_BILLS = [
  { id:"cd1", analyzedAt:mkDemoDate(5), result:{ billType:"ELECTRIC", provider:"Duke Energy Carolinas", accountNumber:"COM-8841-7712", billingPeriod:"Oct 15 – Nov 14, 2024", totalCharged:"$4,218.40", totalUsage:"32,400 kWh", ratePerUnit:"$0.0918 per kWh (blended)", billStatus:"SUSPICIOUS", billStatusReason:"Demand charge of $842 applied at 28.0 kW — but load profile data shows actual peak demand of 21.4 kW. Demand ratchet clause may be incorrectly applied.", suspiciousCharges:["Demand charge based on 28.0 kW — measured peak was 21.4 kW. Possible ratchet from 3 months ago still in effect","Power factor charge applied at 0.82 PF — borderline; verify metered PF against invoice"], potentialErrors:["Rate schedule GS-2 may not be optimal — GS-3 with TOU demand structure could be cheaper at this load factor","Facility charge doubled vs prior month — verify against current tariff"], usageRating:"AVERAGE", usageRatingExplanation:"32,400 kWh/month is consistent with a 15,000–20,000 sq ft office facility. Load factor of 48% suggests significant demand charge exposure.", regionalComparison:{yourBill:"$4,218.40",regionalAverage:"$3,640.00",percentageDifference:"+16% above average",comparisonNote:"Above average primarily due to demand charge anomaly and possible ratchet application."}, recommendations:{ negotiation:[{title:"Dispute Demand Ratchet Immediately",description:"Call Duke Energy Commercial at 1-800-777-9898. Request the demand register data for the billing period. If your actual peak was 21.4 kW, the 28.0 kW demand charge is an overcharge of ~$195 this month. Also request retroactive review of prior 3 months.",estimatedSavings:"$150–$240/month",difficulty:"Easy"}], ratePlans:[{title:"Rate Schedule Comparison — GS-2 vs GS-3 vs TOU-GS",description:"At 32,400 kWh/month with a 48% load factor, Duke's TOU-GS rate often outperforms GS-2. Request a rate comparison analysis from your Duke account rep.",estimatedSavings:"$300–$600/month",difficulty:"Medium"}], providers:[{title:"Power Purchase Agreement (PPA) — Commercial Solar",description:"At this usage level, a 150–200 kW rooftop solar PPA eliminates 40–60% of energy charges with $0 upfront cost.",estimatedSavings:"$800–$1,400/month",difficulty:"Hard"}], equipment:[{title:"Power Factor Correction Capacitors",description:"Installing capacitor banks to raise PF from 0.82 to 0.95+ eliminates power factor penalties and may reduce demand charges 8–12%.",estimatedSavings:"$200–$380/month",difficulty:"Medium",upfrontCost:"$3,000–$8,000"}], behavioral:[{title:"Demand Peak Shaving — HVAC Pre-Cooling",description:"Pre-cool the facility to 69°F by 6 AM before occupancy. Allow setback to 74°F during the 11 AM–3 PM peak window. Reduces measured demand 15–25%.",estimatedSavings:"$120–$200/month",difficulty:"Medium"}], incentives:[{title:"Federal Solar ITC (30%) — Commercial",description:"If you own the building, a commercial solar installation qualifies for 30% ITC plus 5-year MACRS depreciation. At $300K installed, that's $90K in federal credits.",estimatedSavings:"One-time $80,000–$130,000",difficulty:"Hard"}] }, totalPotentialMonthlySavings:"$600–$1,200/month", totalPotentialAnnualSavings:"$7,200–$14,400/year", priorityAction:"Dispute the demand ratchet charge immediately — call Duke Energy Commercial today and request the demand register data. This is a probable billing error worth $150–$240/month.", analysisConfidence:"HIGH", confidenceNote:"Demand anomaly clearly visible in billing data." }},
  { id:"cd2", analyzedAt:mkDemoDate(4), result:{ billType:"GAS", provider:"Piedmont Natural Gas — Commercial", accountNumber:"COM-GS-9921", billingPeriod:"Nov 15 – Dec 14, 2024", totalCharged:"$2,840.10", totalUsage:"1,840 therms", ratePerUnit:"$1.298 per therm", billStatus:"NEEDS_REVIEW", billStatusReason:"Billed on Rate Schedule CS-1 (Small Commercial). At 1,840 therms/month, Rate Schedule CS-2 (Large Commercial) with transportation service option should be evaluated — potential 18–22% savings.", suspiciousCharges:["Rate class CS-1 applied — usage volume qualifies for CS-2 classification"], potentialErrors:["Gas cost adjustment charge is 14% of total — verify against published monthly GCA factor for NC","No interruptible service rider evaluated"], usageRating:"HIGH", usageRatingExplanation:"1,840 therms/month is above typical small commercial baseline. This is consistent with a facility using gas for HVAC, hot water, and process heating.", regionalComparison:{yourBill:"$2,840.10",regionalAverage:"$2,310.00",percentageDifference:"+23% above average",comparisonNote:"Significantly above average — rate class mismatch is the primary driver."}, recommendations:{ negotiation:[{title:"Request Rate Reclassification to CS-2",description:"Call Piedmont Commercial at 1-800-752-7504. Request a rate schedule analysis for your account. Reclassification to CS-2 with transportation service could save 18–22% on your gas cost.",estimatedSavings:"$420–$620/month",difficulty:"Easy"}], ratePlans:[{title:"Interruptible Service Rider",description:"If your facility can tolerate occasional gas curtailment (rare in NC), the interruptible rider saves 15–30% on commodity cost.",estimatedSavings:"$280–$560/month",difficulty:"Medium"}], providers:[{title:"Gas Transportation with Retail Supplier",description:"NC allows large commercial customers to purchase gas commodity separately from transport. Compare retail suppliers — typical savings 10–18% on commodity cost.",estimatedSavings:"$180–$360/month",difficulty:"Medium"}], equipment:[{title:"Boiler Tune-Up + Stack Economizer",description:"A full boiler service ($300–$600) combined with a stack economizer captures 10–15% of flue gas heat. Payback typically 18–24 months.",estimatedSavings:"$200–$380/month",difficulty:"Medium",upfrontCost:"$2,000–$6,000"}], behavioral:[{title:"Heating Schedule Optimization",description:"Reduce occupied setpoints by 3–4°F and extend unoccupied setback periods. For a building this size, each degree saves $40–$80/month.",estimatedSavings:"$120–$240/month",difficulty:"Easy"}], incentives:[{title:"Piedmont Natural Gas — Commercial Efficiency Rebate",description:"Up to $10,000 in rebates for qualifying high-efficiency commercial boiler or HVAC replacements.",estimatedSavings:"One-time $3,000–$10,000",difficulty:"Medium"}] }, totalPotentialMonthlySavings:"$500–$900/month", totalPotentialAnnualSavings:"$6,000–$10,800/year", priorityAction:"Call Piedmont today to request a CS-2 rate reclassification — this is the single largest savings opportunity and requires only a phone call to verify eligibility.", analysisConfidence:"HIGH", confidenceNote:"Rate class issue clearly identifiable from usage volume vs. tariff schedule." }},
  { id:"cd3", analyzedAt:mkDemoDate(3), result:{ billType:"WATER", provider:"City of Raleigh Utilities — Commercial", accountNumber:"COM-WS-3312", billingPeriod:"Dec 1 – Dec 31, 2024", totalCharged:"$1,640.80", totalUsage:"148,000 gallons", ratePerUnit:"$0.0089 per gallon (blended)", billStatus:"SUSPICIOUS", billStatusReason:"Sewer charge applied to full metered volume including cooling tower makeup water. Cooling tower evaporation (~40% of makeup) does not enter sewer — credit should apply. Also: fire suppression system test discharge incorrectly included in billable sewer.", suspiciousCharges:["Sewer charged on 100% of consumption — cooling tower evaporation (~60,000 gal) should be excluded","Fire suppression test discharge (est. 8,000 gal) included in sewer — should be waived per municipal code"], potentialErrors:["No submetering on cooling tower — required to claim evaporation credit","Tier 3 rate applied at 108,000 gallons — verify tier boundaries against current commercial tariff"], usageRating:"AVERAGE", usageRatingExplanation:"148,000 gallons is consistent with a commercial office building with cooling tower and 50+ occupants in December (low cooling load).", regionalComparison:{yourBill:"$1,640.80",regionalAverage:"$1,180.00",percentageDifference:"+39% above average",comparisonNote:"Well above average — sewer calculation errors are the primary driver."}, recommendations:{ negotiation:[{title:"Dispute Cooling Tower Sewer Charge",description:"Submit a formal dispute to Raleigh Utilities Water Billing (919-996-3245). Provide your cooling tower make-up meter data or an engineering estimate of evaporation rate (~40% of makeup). Request retroactive credit for up to 24 months.",estimatedSavings:"$300–$520/month",difficulty:"Medium"}], ratePlans:[{title:"Install Cooling Tower Submeter",description:"A dedicated submeter on cooling tower makeup water quantifies evaporation exactly — enabling a permanent, automatic sewer credit. Payback in 3–5 months.",estimatedSavings:"$280–$480/month ongoing",difficulty:"Medium"}], providers:[], equipment:[{title:"Cooling Tower Efficiency Upgrade",description:"Variable speed drives on cooling tower fans + advanced conductivity controls reduce blowdown by 30–40% and makeup water by 15–20%.",estimatedSavings:"$180–$300/month",difficulty:"Hard",upfrontCost:"$8,000–$20,000"}], behavioral:[{title:"Fire Suppression Test Scheduling",description:"Schedule annual suppression tests to coincide with irrigation season when the test discharge can be directed to landscaping — eliminating the sewer charge.",estimatedSavings:"$60–$120 per test event",difficulty:"Easy"}], incentives:[{title:"EPA WaterSense — Industrial Water Efficiency Grant",description:"EPA and NC DEQ offer grants for commercial water efficiency projects over $10K. Application requires engineering assessment.",estimatedSavings:"One-time $5,000–$25,000",difficulty:"Hard"}] }, totalPotentialMonthlySavings:"$500–$850/month", totalPotentialAnnualSavings:"$6,000–$10,200/year", priorityAction:"Submit a formal cooling tower sewer dispute to Raleigh Utilities — this is a documented billing error worth $300–$520/month with potential 24-month retroactive credit.", analysisConfidence:"HIGH", confidenceNote:"Billing error clearly documented. Engineering estimate of evaporation rate needed to support dispute." }},
  { id:"cd4", analyzedAt:mkDemoDate(2), result:{ billType:"ELECTRIC", provider:"Duke Energy Carolinas", accountNumber:"COM-8841-7712", billingPeriod:"Jan 15 – Feb 14, 2025", totalCharged:"$3,890.20", totalUsage:"30,100 kWh", ratePerUnit:"$0.0901 per kWh (blended)", billStatus:"LIKELY_CORRECT", billStatusReason:"Demand ratchet dispute partially resolved — demand charge adjusted to 23.8 kW after meter data review. Power factor improved to 0.88.", suspiciousCharges:[], potentialErrors:["Rate schedule review still pending — TOU-GS comparison not yet completed"], usageRating:"AVERAGE", usageRatingExplanation:"30,100 kWh in January is within normal range. Slight decrease from October likely due to lower cooling load.", regionalComparison:{yourBill:"$3,890.20",regionalAverage:"$3,640.00",percentageDifference:"+7% above average",comparisonNote:"Approaching average — demand dispute resolution dropped bill $328 from October."}, recommendations:{ negotiation:[{title:"Escalate Rate Schedule Review",description:"Follow up with your Duke Energy account rep on the TOU-GS vs GS-2 comparison requested in November. This analysis is overdue.",estimatedSavings:"$300–$600/month",difficulty:"Medium"}], ratePlans:[{title:"TOU-GS Rate — Activate Before Summer",description:"Summer peak demand pricing under TOU-GS is significantly lower off-peak. Enrolling before May positions you for the full summer savings window.",estimatedSavings:"$350–$650/month May–Sep",difficulty:"Medium"}], providers:[{title:"Community Solar Subscription",description:"NC allows commercial community solar subscriptions — bill credit of 8–12 cents/kWh on subscribed capacity.",estimatedSavings:"$200–$400/month",difficulty:"Easy"}], equipment:[{title:"LED Lighting Retrofit",description:"If not already completed, a full LED retrofit on 50,000 sq ft reduces lighting kWh 60–70%. Often payback under 2 years with Duke rebates.",estimatedSavings:"$280–$440/month",difficulty:"Medium",upfrontCost:"$15,000–$30,000"}], behavioral:[{title:"Occupancy-Based HVAC Scheduling",description:"Tighten unoccupied setpoints (heating to 58°F nights/weekends). 14-hour daily setback at this facility size saves significantly.",estimatedSavings:"$150–$280/month",difficulty:"Easy"}], incentives:[{title:"Duke Energy — Custom Energy Efficiency Rebate",description:"For facilities over 500 kW demand, Duke offers custom rebates based on actual kWh saved. LED retrofits, HVAC upgrades, VFDs all qualify.",estimatedSavings:"One-time $10,000–$40,000",difficulty:"Medium"}] }, totalPotentialMonthlySavings:"$500–$950/month", totalPotentialAnnualSavings:"$6,000–$11,400/year", priorityAction:"Escalate the TOU-GS rate comparison with your Duke account rep — this should have been completed 60 days ago and could save $300–$600 every month.", analysisConfidence:"HIGH", confidenceNote:"Dispute resolution improving bill accuracy. Rate optimization remains open." }},
  { id:"cd5", analyzedAt:mkDemoDate(1), result:{ billType:"GAS", provider:"Piedmont Natural Gas — Commercial", accountNumber:"COM-GS-9921", billingPeriod:"Feb 15 – Mar 14, 2025", totalCharged:"$1,980.40", totalUsage:"1,340 therms", ratePerUnit:"$1.198 per therm", billStatus:"LIKELY_CORRECT", billStatusReason:"Rate reclassification to CS-2 applied this billing period. Transportation service option active. Bill dropped $859 from December.", suspiciousCharges:[], potentialErrors:[], usageRating:"AVERAGE", usageRatingExplanation:"1,340 therms in late winter is appropriate. Usage declining as heating load decreases.", regionalComparison:{yourBill:"$1,980.40",regionalAverage:"$1,850.00",percentageDifference:"+7% above average",comparisonNote:"Much closer to average after rate reclassification. $859 monthly savings achieved."}, recommendations:{ negotiation:[], ratePlans:[{title:"Interruptible Service Rider — Evaluate for Next Season",description:"Now on CS-2, the next optimization is the interruptible rider. With adequate backup heating, it can save 15–25% on commodity.",estimatedSavings:"$180–$360/month",difficulty:"Medium"}], providers:[{title:"Retail Gas Supplier Comparison",description:"As a CS-2 transportation customer, you can now shop gas commodity from retail suppliers. Request quotes from at least 3 suppliers.",estimatedSavings:"$100–$250/month",difficulty:"Medium"}], equipment:[{title:"Heat Recovery Unit on Boiler Exhaust",description:"A waste heat recovery unit on your commercial boiler can recapture 10–15% of input energy as usable heat.",estimatedSavings:"$140–$260/month",difficulty:"Hard",upfrontCost:"$12,000–$28,000"}], behavioral:[{title:"Spring Heating Transition Protocol",description:"Establish a written protocol for spring transition: setpoints, boiler cycling, pilot lights. Prevents over-heating in April/May shoulder season.",estimatedSavings:"$80–$150/month Apr–May",difficulty:"Easy"}], incentives:[{title:"NC Utilities Commission — Industrial Efficiency Program",description:"NCUC-approved incentive for large commercial boiler replacements and heat recovery installations.",estimatedSavings:"One-time $5,000–$20,000",difficulty:"Hard"}] }, totalPotentialMonthlySavings:"$280–$530/month", totalPotentialAnnualSavings:"$3,360–$6,360/year", priorityAction:"Request retail gas supplier quotes — you're now on transportation service and can shop commodity rates. This is immediate savings with no facility changes required.", analysisConfidence:"HIGH", confidenceNote:"Clean bill. Rate reclassification confirmed and applied." }},
  { id:"cd6", analyzedAt:mkDemoDate(0), result:{ billType:"WATER", provider:"City of Raleigh Utilities — Commercial", accountNumber:"COM-WS-3312", billingPeriod:"Mar 1 – Mar 31, 2025", totalCharged:"$1,140.60", totalUsage:"121,000 gallons", ratePerUnit:"$0.0089 per gallon (blended)", billStatus:"LIKELY_CORRECT", billStatusReason:"Cooling tower sewer dispute partially resolved. Evaporation credit of $248 applied based on engineering estimate. Cooling tower submeter installation pending.", suspiciousCharges:[], potentialErrors:["Submeter not yet installed — credit based on estimate. Install submeter to lock in exact credit permanently."], usageRating:"AVERAGE", usageRatingExplanation:"121,000 gallons in March is normal — cooling tower not yet at summer load. Reduction from December reflects lower makeup water demand.", regionalComparison:{yourBill:"$1,140.60",regionalAverage:"$1,180.00",percentageDifference:"-3% below average",comparisonNote:"Now at or below average after sewer credit applied. $500/month improvement from December."}, recommendations:{ negotiation:[{title:"Finalize Submeter Installation for Permanent Credit",description:"Raleigh Utilities will convert the estimate-based credit to a permanent metered credit once the cooling tower submeter is installed. Schedule installation before April cooling season.",estimatedSavings:"$280–$480/month ongoing (locked in)",difficulty:"Medium"}], ratePlans:[], providers:[], equipment:[{title:"Advanced Conductivity Controller for Cooling Tower",description:"Automated blowdown control based on real conductivity vs. timer-based blowdown reduces water use 20–30% and chemical costs.",estimatedSavings:"$120–$220/month",difficulty:"Medium",upfrontCost:"$2,500–$5,000"}], behavioral:[{title:"Weekly Cooling Tower Inspection Protocol",description:"Establish a weekly blowdown log and drift eliminator check. Prevents Legionella risk and maintains efficiency. Required by ASHRAE 188.",estimatedSavings:"$60–$100/month in chemical and water savings",difficulty:"Easy"}], incentives:[{title:"NC DEQ Water Efficiency Grant",description:"North Carolina DEQ offers grants for commercial water efficiency projects. Cooling tower upgrades are a qualifying category.",estimatedSavings:"One-time $3,000–$15,000",difficulty:"Hard"}] }, totalPotentialMonthlySavings:"$350–$650/month", totalPotentialAnnualSavings:"$4,200–$7,800/year", priorityAction:"Install the cooling tower submeter before April — this converts the estimate-based sewer credit to a permanent metered credit and protects $280–$480/month in savings.", analysisConfidence:"HIGH", confidenceNote:"Sewer dispute progress documented. Submeter installation is the critical next step." }},
];
...
const PdfPreview = ({ html, onClose, filename }) => {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.85)", zIndex: 9999, display: "flex", flexDirection: "column" }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 18px", background: "#0d0d1a", borderBottom: "1px solid rgba(56,189,248,0.2)", flexShrink: 0 }}>
        <div style={{ fontFamily: "'DM Mono',monospace", fontSize: "11px", color: "#38BDF8", letterSpacing: "0.12em" }}>📄 REPORT PREVIEW</div>
        <div style={{ display: "flex", gap: "8px" }}>
          <button onClick={download} style={{ background: "linear-gradient(135deg,#38BDF8,#0EA5E9)", border: "none", color: "#040d18", padding: "7px 14px", borderRadius: "7px", cursor: "pointer", fontSize: "11px", fontWeight: "700", fontFamily: "monospace" }}>↓ Download Report</button>
          <button onClick={onClose} style={{ background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.12)", color: "#aaa", padding: "7px 14px", borderRadius: "7px", cursor: "pointer", fontSize: "11px", fontFamily: "monospace" }}>✕ Close</button>
        </div>
      </div>
      {blobUrl && <iframe src={blobUrl} style={{ flex: 1, border: "none", background: "#fff" }} title="PDF Preview" />}
    </div>
  );
};
...
const DemoPage = ({ type }) => {
  ...
  const [demoTab, setDemoTab] = useState("single");
  const [selectedIdx, setSelectedIdx] = useState(0);
  const [activeRecTab, setActiveRecTab] = useState("negotiation");
  const [pdfHtml, setPdfHtml] = useState(null);
  const [pdfFilename, setPdfFilename] = useState("");
  const [multiSelected, setMultiSelected] = useState(new Set(bills.map(b => b.id)));
  const [billTypeError, setBillTypeError] = useState(null);
  ...
  const openSinglePdf = () => {
    ...
    setPdfHtml(html);
    setPdfFilename(`mymeteriq-${isResidential ? "residential" : "commercial"}-single-report.html`);
  };

  const openMultiPdf = () => {
    const selected = bills.filter(b => multiSelected.has(b.id));
    if (selected.length < 2) return;
    const types = new Set(selected.map(b => b.result.billType));
    if (types.size > 1) {
      setBillTypeError(`Cannot compare different bill types: ${[...types].join(" vs ")}. Select only Electric, only Gas, or only Water bills.`);
      return;
    }
    setBillTypeError(null);
    const html = buildCompareReport(selected[0], selected[selected.length - 1], emptyActions);
    setPdfHtml(html);
    setPdfFilename(`mymeteriq-${isResidential ? "residential" : "commercial"}-comparison-report.html`);
  };
  ...
  const validMulti = bills.filter(b => multiSelected.has(b.id));
  const sortedMulti = [...bills].sort((a, b) => new Date(a.analyzedAt) - new Date(b.analyzedAt));
  const chartData = sortedMulti.map(b => ({
  ...
  const avg = bills.reduce((x, b) => x + parseNum(b.result.totalCharged), 0) / bills.length;
  const sorted = [...bills].sort((a, b) => new Date(a.analyzedAt) - new Date(b.analyzedAt));
  const cd = parseNum(sorted[sorted.length - 1].result.totalCharged) - parseNum(sorted[0].result.totalCharged);
  const susp = bills.filter(b => b.result.billStatus === "SUSPICIOUS").length;

  const DEMO_TABS = [
    { key: "single", label: "Single Bill Analysis", icon: "⚡" },
    { key: "multi", label: "Multi-Bill Trends", icon: "📊" },
    { key: "singlepdf", label: "Single Bill PDF", icon: "📄" },
    { key: "multipdf", label: "Multi-Bill PDF", icon: "📋" },
  ];
    ...
    <div style={{ minHeight: "100vh", width: "100%", maxWidth: "100vw", overflowX: "hidden", background: T.bg, fontFamily: "'DM Sans',system-ui,sans-serif", color: T.text, transition: "background .3s,color .3s" }}>
      <style>{`
        ...
        *{transition:background-color .2s,border-color .2s,color .15s}
        ...
        .dtb:hover{color:${T.isDark?"#aaa":"#374151"};background:${T.isDark?"rgba(255,255,255,.04)":"rgba(0,0,0,0.04)"}}
        .dta{color:#38BDF8!important;background:rgba(56,189,248,.12)!important;border:1px solid rgba(56,189,248,0.2)!important}
        .rtb{background:none;border:none;cursor:pointer;padding:7px 12px;border-radius:6px;font-family:'DM Mono',monospace;font-size:11px;font-weight:600;letter-spacing:.05em;transition:all .15s;color:${T.navBtn}}
        .rtb:hover{background:rgba(56,189,248,.07);color:${T.isDark?"#aaa":"#374151"}}
        .rta{background:${T.tabActive}!important;color:#38BDF8!important}
        .br2{background:${T.billRowBg};border:1px solid ${T.billRowBorder};border-radius:8px;padding:12px 15px;margin-bottom:7px;display:flex;align-items:center;gap:12px;cursor:pointer;transition:all .15s}
        .br2:hover{background:rgba(56,189,248,.04);border-color:rgba(56,189,248,.2)}
        .br2.sel{border-color:rgba(56,189,248,.4);background:rgba(56,189,248,.06)}
      `}</style>
      ...
      <div style={{ borderBottom: `1px solid ${T.topbarBorder}`, padding: isMobile ? "10px 14px" : "12px 24px", display: "flex", alignItems: "center", justifyContent: "space-between", position: "sticky", top: 0, background: T.topbar, zIndex: 100, backdropFilter: "blur(10px)", flexWrap: "wrap", gap: "8px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          ...
          <div>
            <div style={{ fontFamily: "'DM Mono',monospace", fontSize: "13px", fontWeight: "600", letterSpacing: "0.02em" }}><span style={{ color: "#E8EAF0" }}>MyMeter</span><span style={{ color: "#38BDF8" }}>IQ</span></div>
      ...
      <div style={{ maxWidth: "1080px", margin: "0 auto", padding: isMobile ? "14px 12px" : "28px 20px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "240px 1fr", gap: "16px" }}>
              ...
              <div>
                ...
                <div style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: "10px", overflow: "hidden" }}>
                  <div style={{ padding: "10px 13px", borderBottom: `1px solid ${T.border}`, display: "flex", gap: "3px", flexWrap: "wrap", background: T.bgCard2 }}>
                    {TABS.map(t => <button key={t.key} className={`rtb ${activeRecTab === t.key ? "rta" : ""}`} onClick={() => setActiveRecTab(t.key)}>{t.icon} {t.label}</button>)}
                  </div>
                  <div style={{ padding: "14px" }}>
                    {(r.recommendations?.[activeRecTab] || []).length > 0
                      ? (r.recommendations?.[activeRecTab] || []).map((item, i) => (
                        <div key={i} style={{ background: T.recBg, border: `1px solid ${T.recBorder}`, borderRadius: "9px", padding: "13px 14px", marginBottom: "8px" }}>
                          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "8px", marginBottom: "4px" }}>
                            <span style={{ fontFamily: "'DM Mono',monospace", fontSize: "12px", fontWeight: "600", color: "#38BDF8" }}>{item.title}</span>
                            <DiffPill d={item.difficulty} />
                          </div>
                          <div style={{ fontSize: "12px", color: T.textSub, lineHeight: "1.6", marginBottom: "6px" }}>{item.description}</div>
                          <div style={{ display: "flex", gap: "14px", flexWrap: "wrap" }}>
                            <span style={{ fontSize: "11px" }}><span style={{ color: T.textDim }}>Saves: </span><span style={{ color: "#34C759", fontWeight: "700", fontFamily: "monospace" }}>{item.estimatedSavings}</span></span>
                            {item.upfrontCost && <span style={{ fontSize: "11px" }}><span style={{ color: T.textDim }}>Cost: </span><span style={{ color: "#FF9500", fontFamily: "monospace" }}>{item.upfrontCost}</span></span>}
                          </div>
                        </div>
                      ))
                      : <div style={{ color: T.textDim, fontSize: "12px", padding: "12px 0" }}>No recommendations in this category for this bill.</div>
                    }
                  </div>
                </div>
              </div>
        ...
        {/* ══ TAB 2: MULTI-BILL TRENDS ══ */}
        {demoTab === "multi" && (
          <div>
            {/* KPI Cards */}
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(170px,1fr))", gap: "10px", marginBottom: "22px" }}>
              {[
                { label: "Avg Monthly Bill", v: `$${avg.toFixed(2)}`, c: T.text, note: `${bills.length} bills tracked` },
                { label: "Cost Trend", v: cd >= 0 ? `+$${cd.toFixed(2)}` : `-$${Math.abs(cd).toFixed(2)}`, c: cd > 10 ? "#FF3B30" : cd < -10 ? "#34C759" : "#FF9500", note: "first → latest" },
                { label: "Flagged Bills", v: `${susp}/${bills.length}`, c: susp > 0 ? "#FF3B30" : "#34C759", note: susp > 0 ? "need attention" : "all clear" },
                { label: "Utilities Tracked", v: "3", c: "#38BDF8", note: "Electric · Gas · Water" },
              ].map(x => (
                <div key={x.label} style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: "10px", padding: "16px 18px" }}>
                  <div style={{ fontSize: "9px", color: T.textDim, textTransform: "uppercase", letterSpacing: "0.12em", marginBottom: "6px" }}>{x.label}</div>
                  <div style={{ fontFamily: "'DM Mono',monospace", fontSize: "20px", fontWeight: "700", color: x.c }}>{x.v}</div>
              ...
              <div style={CARD}>
                ...
                <ResponsiveContainer width="100%" height={165}>
                  <LineChart data={chartData} margin={{ top: 5, right: 8, left: -22, bottom: 5 }}>
                    ...
                    <Line type="monotone" dataKey="Cost" stroke="#38BDF8" strokeWidth={2} dot={{ fill: "#38BDF8", r: 4, strokeWidth: 0 }} activeDot={{ r: 6 }} name="Cost" />
                  </LineChart>
                </ResponsiveContainer>
              </div>
              <div style={CARD}>
                <div style={{ fontSize: "9px", color: T.textDim, textTransform: "uppercase", letterSpacing: "0.12em", marginBottom: "12px", fontFamily: "monospace" }}>Bill Status Timeline</div>
            ...
            {/* Bill list */}
            <div style={CARD}>
              <SecHeader icon="🗂" title={`All ${bills.length} Bills`} T={T} />
              {bills.map((b, i) => (
                <div key={b.id} className="br2" onClick={() => { setSelectedIdx(i); setDemoTab("single"); }} style={{ cursor: "pointer" }}>
                  <span style={{ fontSize: "18px" }}>{BILL_TYPE_ICON[b.result.billType] || "⚡"}</span>
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ fontFamily: "monospace", fontSize: "11px", fontWeight: "700", color: billTypeColors[b.result.billType] || "#38BDF8" }}>{b.result.provider}</div>
                    <div style={{ fontSize: "10px", color: T.textDim }}>{b.result.billingPeriod}</div>
                  </div>
                  <div style={{ textAlign: "right" }}>
                    <div style={{ fontFamily: "monospace", fontSize: "13px", fontWeight: "700" }}>{b.result.totalCharged}</div>
                    <StatusBadge status={b.result.billStatus} small />
                  </div>
                  <div style={{ fontSize: "10px", color: "#34C759", fontFamily: "monospace", flexShrink: 0, fontWeight: "700", minWidth: "80px", textAlign: "right" }}>{b.result.totalPotentialMonthlySavings?.split("–")[0]}/mo</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "240px 1fr", gap: "16px" }}>
              ...
              <div style={{ ...CARD, textAlign: "center" }}>
                ...
                <div style={{ fontFamily: "'DM Serif Display',serif", fontSize: "20px", marginBottom: "8px" }}>{bills[selectedIdx].result.provider}</div>
                <div style={{ fontSize: "13px", color: T.textSub, marginBottom: "6px" }}>{bills[selectedIdx].result.billingPeriod}</div>
                <div style={{ display: "flex", gap: "12px", justifyContent: "center", marginBottom: "20px", flexWrap: "wrap" }}>
                  <span style={{ fontFamily: "monospace", fontSize: "13px", fontWeight: "700" }}>{bills[selectedIdx].result.totalCharged}</span>
                  <StatusBadge status={bills[selectedIdx].result.billStatus} />
                </div>
                <div style={{ background: T.bgCard2, border: `1px solid ${T.border}`, borderRadius: "8px", padding: "12px 16px", marginBottom: "20px", fontSize: "12px", color: T.textSub, textAlign: "left", lineHeight: "1.6" }}>
                  The PDF report includes: bill summary, regional comparison, usage analysis, all recommendations with savings estimates, sources & methodology, and a priority action panel.
                </div>
                <button onClick={openSinglePdf} style={{ background: "linear-gradient(135deg,#38BDF8,#0EA5E9)", border: "none", color: "#040d18", padding: "14px 32px", borderRadius: "9px", cursor: "pointer", fontSize: "14px", fontWeight: "700", fontFamily: "monospace", boxShadow: "0 4px 16px rgba(56,189,248,0.25)", display: "inline-flex", alignItems: "center", gap: "8px" }}>
                  📄 Preview PDF Report
                </button>
                <div style={{ fontSize: "10px", color: T.textDim, marginTop: "10px" }}>Opens inline · Download button inside preview</div>
              </div>
            </div>
          </div>
        )}

        {/* ══ TAB 4: MULTI-BILL PDF WITH PICKER ══ */}
        {demoTab === "multipdf" && (
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: "20px" }}>
              ...
              <div style={CARD}>
                ...
                {bills.map(b => (
                  <div key={b.id} onClick={() => toggleBill(b.id)} style={{ display: "flex", alignItems: "center", gap: "12px", padding: "10px 12px", borderRadius: "8px", border: `1px solid ${multiSelected.has(b.id) ? "rgba(56,189,248,0.3)" : T.border}`, background: multiSelected.has(b.id) ? "rgba(56,189,248,0.06)" : T.bgCard2, marginBottom: "7px", cursor: "pointer", transition: "all .15s" }}>
                    <div style={{ width: "20px", height: "20px", borderRadius: "5px", border: `2px solid ${multiSelected.has(b.id) ? "#38BDF8" : T.border}`, background: multiSelected.has(b.id) ? "#38BDF8" : "transparent", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, color: "#040d18", fontSize: "11px", fontWeight: "700" }}>
                      {multiSelected.has(b.id) ? "✓" : ""}
                    </div>
                    <span style={{ fontSize: "16px" }}>{BILL_TYPE_ICON[b.result.billType] || "⚡"}</span>
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ fontFamily: "monospace", fontSize: "11px", fontWeight: "700", color: billTypeColors[b.result.billType] || "#38BDF8" }}>{b.result.billType}</div>
                      <div style={{ fontSize: "10px", color: T.textDim }}>{shortPeriod(b.result.billingPeriod)}</div>
                    </div>
                    <div style={{ textAlign: "right" }}>
                      <div style={{ fontFamily: "monospace", fontSize: "12px", fontWeight: "700" }}>{b.result.totalCharged}</div>
                      <StatusBadge status={b.result.billStatus} small />
                    </div>
                  </div>
                ))}
                <div style={{ marginTop: "8px", fontSize: "10px", color: T.textDim }}>
                  {multiSelected.size} of {bills.length} selected · Report compares first ↔ last selected
                </div>
              </div>

              {/* Preview panel */}
              <div style={{ ...CARD, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", minHeight: "360px" }}>
                <div style={{ fontSize: "48px", marginBottom: "16px" }}>📋</div>
                <div style={{ fontFamily: "'DM Serif Display',serif", fontSize: "20px", marginBottom: "8px" }}>Comparison Report</div>
                {validMulti.length >= 2 ? (
                  <>
                    <div style={{ fontSize: "12px", color: T.textSub, marginBottom: "16px", lineHeight: "1.6" }}>
                      Comparing <span style={{ color: "#38BDF8", fontFamily: "monospace", fontWeight: "700" }}>{shortPeriod(sorted[0].result.billingPeriod)}</span>
                      <br />to<br />
                      <span style={{ color: "#34C759", fontFamily: "monospace", fontWeight: "700" }}>{shortPeriod(sorted[sorted.length - 1].result.billingPeriod)}</span>
                    </div>
                    <div style={{ background: T.bgCard2, border: `1px solid ${T.border}`, borderRadius: "8px", padding: "12px 16px", marginBottom: "20px", fontSize: "12px", color: T.textSub, textAlign: "left", lineHeight: "1.6", width: "100%" }}>
                      Report includes: side-by-side bill metrics, cost & usage changes, rate comparison, recommendations that appear in one or both bills, and persistent issues across billing periods.
                    </div>
                    {billTypeError && (
                      <div style={{ background: "rgba(255,59,48,0.08)", border: "1px solid rgba(255,59,48,0.3)", borderRadius: "8px", padding: "10px 14px", marginBottom: "14px", fontSize: "12px", color: "#FF6B6B", width: "100%", textAlign: "left", lineHeight: "1.5" }}>
                        🚫 {billTypeError}
                      </div>
                    )}
                    <button onClick={openMultiPdf} style={{ background: "linear-gradient(135deg,#38BDF8,#0EA5E9)", border: "none", color: "#040d18", padding: "14px 32px", borderRadius: "9px", cursor: "pointer", fontSize: "14px", fontWeight: "700", fontFamily: "monospace", boxShadow: "0 4px 16px rgba(56,189,248,0.25)", display: "inline-flex", alignItems: "center", gap: "8px" }}>
                      📋 Preview Comparison Report
                    </button>
                    <div style={{ fontSize: "10px", color: T.textDim, marginTop: "10px" }}>Opens inline · Download button inside preview</div>
                  </>
                ) : (
                  <div style={{ fontSize: "13px", color: T.textDim }}>Select at least 2 bills to generate a comparison report.</div>
                )}
              </div>
            </div>
          </div>
...
export default function App() {
  ...
  const demoPath = window.location.pathname.replace(/\/$/, "").toLowerCase();
  if (demoPath === "/residentialdemo" || demoPath === "/residentialdemo/") {
    return <DemoPage type="residential" />;
  }
  if (demoPath === "/commercialdemo" || demoPath === "/commercialdemo/") {
  ...
  return (
    <div style={{minHeight:"100vh",background:T.bg,fontFamily:"'DM Sans',system-ui,sans-serif",color:T.text,transition:"background .3s,color .3s"}}>
      ...
      <div style={{borderBottom:`1px solid ${T.topbarBorder}`,padding:isMobile?"10px 14px":"12px 24px",display:"flex",alignItems:"center",justifyContent:"space-between",position:"sticky",top:0,background:T.topbar,zIndex:100,backdropFilter:"blur(10px)",flexWrap:"wrap",gap:"8px"}}>
        <div style={{display:"flex",alignItems:"center",gap:"10px"}}>
          <img src="/logo.svg" alt="MyMeterIQ" style={{width:"44px",height:"44px",borderRadius:"10px",boxShadow:"0 0 12px rgba(56,189,248,.5), 0 0 24px rgba(56,189,248,.2), 0 2px 8px rgba(0,0,0,.4)",flexShrink:0,border:"1px solid rgba(56,189,248,.3)"}}/>
          <div>
            <div style={{fontFamily:"'DM Mono',monospace",fontSize:"13px",fontWeight:"600",letterSpacing:"0.02em"}}><span style={{color:"#E8EAF0"}}>MyMeter</span><span style={{color:"#38BDF8"}}>IQ</span></div>
              ...
              <>
                ...
                <div style={{...CARD}}>
                  <SecHeader icon="🗂" title={`All Bills (${bills.length})`} T={T} right={
                    bills.length>0&&<div style={{display:"flex",alignItems:"center",gap:"10px",flexWrap:"wrap",justifyContent:"flex-end"}}>
                      ...
                      {bills.length>=2&&<div style={{fontSize:"10px",color:T.textDim,fontFamily:"monospace"}}>
                        {compareIds.size===0?"Select 2 bills of the same type":compareIds.size===1?`Select 1 more ${bills.find(b=>compareIds.has(b.id))?.result?.billType||""} bill`:
                  ...
                  {[...bills].filter(b=>b?.result).sort((a,b)=>new Date(b.analyzedAt)-new Date(a.analyzedAt)).map(bill=>{
                    ...
                    const firstSelectedBill = compareIds.size > 0 ? bills.find(b => compareIds.has(b.id)) : null;
                    const isTypeMismatch = !isCompareSelected && compareIds.size === 1 && firstSelectedBill && firstSelectedBill.result.billType !== bill.result.billType;
                    const isCompareDisabled = (compareIds.size===2 && !isCompareSelected) || isTypeMismatch;
                    ...
                    return (
                      <div key={bill.id} className="br"
                        ...
                        {deleteMode?(
                          ...
                          /* Compare checkbox */
                          <button onClick={e=>{e.stopPropagation(); if(isTypeMismatch){return;} setCompareIds(prev=>{const n=new Set(prev); isCompareSelected?n.delete(bill.id):(prev.size<2&&n.add(bill.id)); return n;});}}
                            title={isTypeMismatch?`Can only compare ${firstSelectedBill.result.billType} bills — this is a ${bill.result.billType} bill`:""}
                            style={{flexShrink:0,width:"18px",height:"18px",borderRadius:"4px",
                              border:`2px solid ${isCompareSelected?"#FF9500":isTypeMismatch?"rgba(255,59,48,0.4)":"rgba(255,149,0,0.25)"}`,
                              background:isCompareSelected?"#FF9500":isTypeMismatch?"rgba(255,59,48,0.12)":"transparent",
                              cursor:isCompareDisabled?"not-allowed":"pointer",
                              display:"flex",alignItems:"center",justifyContent:"center",
                              color:"#fff",fontSize:"10px",fontWeight:"700",transition:"all .15s"}}>
                            {isCompareSelected?"✓":isTypeMismatch?"✕":""}
                          </button>
                        )}
                        <div style={{flex:1,minWidth:0}}>
